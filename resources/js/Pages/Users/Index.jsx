            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <Link href={route('users.create')}
                          className="inline-flex items-center my-4 px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
                    >
                        Create User
                    </Link>
                    {/* End Create User */}
                                ...
                                <div className="inline-block py-2 min-w-full align-middle sm:px-6 lg:px-8">
                                    <div className="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                                        ...
                                        <table className="min-w-full divide-y divide-gray-200 table-fixed">
                                            ...
                                            <tr>
                                                <th scope="col"
                                                    className="w-3/12 text-xs font-semibold tracking-wider text-left text-white uppercase">
